...
const (
	...
	TokenAtCall // @Name or @pkg.Name( (uppercase name or adjacent paren, component call)
	TokenAtExpr // @c.field (lowercase dotted name without call parens, renders a Component)
