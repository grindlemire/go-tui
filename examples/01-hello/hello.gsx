...
templ (h *helloApp) Render() {
	<div class="flex-col items-center justify-center h-full">
		<div class="border-rounded border-cyan p-2 gap-1 flex-col items-center">
			<span class="text-gradient-cyan-magenta font-bold">Welcome to go-tui</span>
			<br />
			<span class="text-cyan">Build beautiful terminal UIs</span>
			<span class="text-cyan">with Go and flexbox</span>
			<br />
